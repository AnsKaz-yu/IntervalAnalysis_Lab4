...
# beta_1_int = ip.Interval(12857, 13289.5)

# beta_0_ext = ip.Interval(7780.52, 8430.21)
# beta_1_ext = ip.Interval(12193, 13950.3)
...
for (beta_0, beta_1) in ((beta_0_int, beta_1_int), (beta_0_ext, beta_1_ext)):
  ...
  plt.plot(xs_continuous, ys_a, color='red', linewidth=1.5, linestyle='--', label='Lower Bound')
  plt.plot(xs_continuous, ys_b, color='red', linewidth=1.5, linestyle='--', label='Upper Bound')
  plt.plot(xs_continuous, (ys_a + ys_b) / 2, color='black', linewidth=2, label='Mean')
  plt.xlabel('x')
  plt.ylabel('y')
  plt.legend()
  plt.grid(True)
